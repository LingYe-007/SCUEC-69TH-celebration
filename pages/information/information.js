...
Page({
  data: {
    a1:0,
    array1:["法学院","文学与新闻传播学院","美术学院","民族学与社会学学院","外语学院","经济学院","管理学院","公共管理学院","教育学院","马克思主义学院","计算机科学学院","数学与统计学学院","电子信息工程学院","生物医学工程学院","化学与材料科学学院","资源与环境学院","生命科学学院","药学院","预科教育学院","体育学院","音乐舞蹈学院","继续教育学院","中华民族共同体研究院","研究生院","国际教育学院","教职工"],
    gifUrl:"",
    index:"",
    activeIdx:2,
    ishide:true,   
...
changeRegin(e){
  ...
  f1:function(){
    ...
    wx.request({
      ...
      if(app.area!=that.data.region[1].slice(0,that.data.region[1].length-1)){
    ...
    wx.login({
      success (res) {
        ...
        // }
          ...
          app.area=res.data.Data.ADDRESS[1].slice(0,that.data.region[1].length-1)
